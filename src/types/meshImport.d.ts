declare namespace TSRL.Mesh {
    export type UV_Coordinate = 
        | ({ $type: '2D'; uv: TSRL.DataModel.float2 })
        | ({ $type: '3D'; uv: TSRL.DataModel.float3 })
        | ({ $type: '4D'; uv: TSRL.DataModel.float4 })
    ...
    export interface Vertex {
         ...
         */
        position: TSRL.DataModel.float3;
        /**
         * Normal vector of the vertex
         */
        normal?: TSRL.DataModel.float3;
        /**
         ...
         */
        tangent?: TSRL.DataModel.float4;
        /**
         * Color of the vertex
         */
        color?: TSRL.DataModel.color;
        /**
    ...
    interface PointSubmesh {
         ...
         */
        vertexIndices: TSRL.DataModel.int[];
    }
    ...
    export interface Bone {
         ...
         */
        bindPose: TSRL.DataModel.float4x4;
    }
